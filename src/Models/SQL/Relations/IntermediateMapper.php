...
class IntermediateMapper
{
     ...
     * @return void
     */
    private function __mapReferenceModel( $referenceModel )
    {
     ...
     * @return string
     */
    private function __mapRelationForeignKey()
    {
        $tablePrefixes = [
            't_',
            'tm_',
