...
namespace O2System\Framework\Libraries\Image;
 ...
 * Class Manipulation
 *
 * @package O2System\Framework\Libraries\Image
 */
class Manipulation
{
    /**
    ...
    {
        $protocol = ( $this->imageLibrary === 'gd2' ) ? 'image_process_gd' : 'image_process_' . $this->imageLibrary;
    ...
    public function image_process_imagemagick( $action = 'resize' )
    {
        ...
        if ( $this->imageLibraryPath === '' ) {
            $this->set_error( 'imglib_libpath_invalid' );

            return false;
        }

        if ( ! preg_match( '/convert$/i', $this->imageLibraryPath ) ) {
            $this->imageLibraryPath = rtrim( $this->imageLibraryPath, '/' ) . '/convert';
        }

        // Execute the command
        $cmd = $this->imageLibraryPath . ' -quality ' . $this->quality;
    ...
    public function image_process_netpbm( $action = 'resize' )
    {
        ...
        $cmd = $this->imageLibraryPath . $cmd_in . ' ' . $this->full_src_path . ' | ' . $cmd_inner . ' | ' . $cmd_out . ' > ' . $this->dest_folder . 'netpbm.tmp';
    ...
    public function text_watermark()
    {
        ...
        $txt_color = imagecolorclosest( $src_img, hexdec( $txt_color[ 0 ] ), hexdec( $txt_color[ 1 ] ),
            hexdec( $txt_color[ 2 ] ) );
